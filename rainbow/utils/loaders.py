...
def cleloader(path: str, emu, arch=None, ld_path=(), verbose=False, except_missing_libs=True) -> None:
    ...
    ld = cle.Loader(path, except_missing_libs=except_missing_libs, ld_path=ld_path, arch=arch)
